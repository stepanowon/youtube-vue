...
> Contact : stepanowon@hotmail.com <br/> 
> Author : Stephen Won(원형섭), OpenSG Inc.<br/>  
> Online Demo : [jsfiddle](https://jsfiddle.net/boj2h8h8), [single html](http://sample.bmaster.kro.kr/youtube-vue-sample.html) <br/>
## License
MIT
## Usage  
#### CDN - install
